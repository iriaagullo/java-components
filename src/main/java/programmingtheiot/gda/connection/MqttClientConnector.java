...
public class MqttClientConnector implements IPubSubClient, MqttCallbackExtended
{
	...
	{
		this._Logger.info("publishMessage() called with topic: " + topicName + ", message: " + msg + ", QoS: " + qos);
	...
	{
		this._Logger.info("subscribeToTopic() called with topic: " + topicName + ", QoS: " + qos);
	...
	{
		this._Logger.info("unsubscribeFromTopic() called with topic: " + topicName);
	...
	{
		this._Logger.info("setDataMessageListener() called.");
